      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="overflow-hidden rounded-xl border border-gold-600/20 dark:border-gold-600/20"
            >
              <div className="aspect-[3/4] animate-pulse bg-parchment-200 dark:bg-ink-800" />
              <div className="space-y-2 p-4">
                <div className="h-3 w-1/3 animate-pulse rounded bg-parchment-200 dark:bg-ink-800" />
                <div className="h-4 w-3/4 animate-pulse rounded bg-parchment-200 dark:bg-ink-800" />
              </div>
            </div>
          ))}
        </div>
