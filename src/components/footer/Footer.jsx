...
export default function Footer() {
    return (
        <footer className="border-t border-gold-600/30 bg-ink-900">
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    <div>
                        ...
                        <Link href="/" className="flex items-center gap-2">
                            <Image
                                ...
                                priority
                            />
                            <span className="font-display text-xl font-bold text-parchment-100">Fable</span>
                        </Link>
                        <p className="mt-2 font-body text-sm text-parchment-200/60">
                    ...
                    <div>
                        <h4 className="font-display text-sm font-semibold tracking-wide text-parchment-100 uppercase">
                            Quick Links
                        </h4>
                        <ul className="mt-3 space-y-2 font-body text-sm text-parchment-200/60">
                            <li>
                    ...
                    <div>
                        ...
                        <div className="mt-3 flex gap-4">
                            <a href="#" aria-label="Facebook" className="text-parchment-200/60 hover:text-gold-400">
                            ...
                            <a href="#" aria-label="Twitter" className="text-parchment-200/60 hover:text-gold-400">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="#" aria-label="Instagram" className="text-parchment-200/60 hover:text-gold-400">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                        ...
                        <form className="mt-3 flex gap-2" onSubmit={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="w-full rounded-sm border border-gold-600/30 bg-ink-800 px-3 py-2 font-body text-sm text-parchment-100 placeholder:text-parchment-200/40 focus:border-gold-500 focus:outline-none"
                            />
                            <button
                                type="submit"
                                className="rounded-sm bg-gold-600 px-3 py-2 font-body text-sm font-medium text-ink-900 hover:bg-gold-500"
                            >
                                Join
                            </button>
                        </form>
                ...
                <div className="mt-10 border-t border-gold-600/20 pt-6 text-center font-body text-sm text-parchment-200/50">
